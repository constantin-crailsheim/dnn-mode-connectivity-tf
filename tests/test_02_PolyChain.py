...
from mode_connectivity.curves import Curve, PolyChain
...
testdata_output = [
    ...
    (4, 0.25, list_as_tensor([0.0, 0.75, 0.25, 0.0, 0.0, 0.0])),
    (4, 0.5, list_as_tensor([0.0, 0.0, 0.5, 0.5, 0.0, 0.0])),
    (4, 0.75, list_as_tensor([0.0, 0.0, 0.0, 0.25, 0.75, 0.0])),
]
