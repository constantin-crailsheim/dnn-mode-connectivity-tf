...
class CurveNet(tf.keras.Model):
    ...
    def init_linear(self) -> None:
        ...
        of the parameters of the first and last node (pretrained models).
        """
    ...
    def call(
        ...
        Args:
            ...
            training (_type_, optional): Indicates train mode. Defaults to None.
        ...
        outputs = self.curve_model((inputs, point_on_curve_weights), training=training)
        return outputs
